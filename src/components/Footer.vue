        ...
        <div class="p-6 font-mono">
          ...
          <div class="flex flex-col md:flex-row md:items-center justify-between py-4 border-t border-terminal-green/20">
            ...
            <div class="flex flex-wrap gap-4 mb-6 md:mb-0">
              <a href="https://github.com/yourusername/DevOpsDiary" target="_blank" class="text-terminal-white hover:text-terminal-green transition-colors duration-200 flex items-center">
              ...
              <a href="https://buymeacoffee.com" target="_blank" class="text-terminal-white hover:text-terminal-green transition-colors duration-200 flex items-center">
                <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
