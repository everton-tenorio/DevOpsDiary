    ...
    <div v-else>
      ...
      <div class="bg-[#1c2128] text-[#E6EDF3] lg:ml-[1px] lg:mr-[1px] ml-[-20px] mr-[-20px] p-6 rounded-lg mb-8">
        <div v-if="project.overview" class="mb-6">
          <h2 class="text-xl font-mono font-bold text-terminal-green mb-4">Learning Objectives</h2>
...
:deep(h2) {
  @apply text-2xl text-terminal-green;
}
:deep(h3) {
  @apply text-xl pt-4 text-terminal-green;
}
:deep(h4) {
  @apply text-[18px] pt-4 text-red-600;
}
:deep(h5) {
  @apply text-[16px] pt-4 text-red-600;
}
:deep(p) {
  @apply mb-6 mt-6;
}
